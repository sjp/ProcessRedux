...
namespace SJP.Process
{
    ...
    public interface IObservableStringStreamingProcess
    {
        ...
        /// <summary>
        /// Starts (or reuses) the process resource that is specified by the <see cref="StartInfo"/> property of this <see cref="IObservableStringStreamingProcess"/> component and associates it with the component.
        /// </summary>
        ...
        /// <summary>
        /// Instructs the <see cref="IObservableStringStreamingProcess"/> component to wait indefinitely for the associated process to exit.
        /// </summary>
