...
namespace SJP.Process
{
    ...
    public interface IObservableBinaryStreamingProcess
    {
        ...
        /// <summary>
        /// Starts (or reuses) the process resource that is specified by the <see cref="StartInfo"/> property of this <see cref="IObservableBinaryStreamingProcess"/> component and associates it with the component.
        /// </summary>
